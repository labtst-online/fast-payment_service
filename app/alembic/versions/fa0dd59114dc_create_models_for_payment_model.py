...
def upgrade():
    ...
    sa.Column('status', sa.Enum('PENDING', 'SUCCEEDED', 'FAILED', 'CANCELED', name='paymentstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_payment_stripe_checkout_session_id'), 'payment', ['stripe_checkout_session_id'], unique=True)
